...
#define make_threeple(a,b,c) std::make_pair(std::make_pair(a,b),c)
#define threeple std::pair<std::pair<Vertex,Vertex>,size_t>
#define threeple_first(t) t.first.first
#define threeple_second(t) t.first.second
#define threeple_third(t) t.second
...
///////////////////////// DEFINITIONS FOR INDIVIDUAL ROADMAP
  ...
  struct CompositeVProp
  {
    ...
    /// t_value, vextex source, vertex target
    std::vector<std::pair<std::pair<Vertex,Vertex>,size_t>> composite_vertex;
    ...
    /// overestimated F_Value
    double over_fval = std::numeric_limits<double>::infinity();
