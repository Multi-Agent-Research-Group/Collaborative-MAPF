...
int main()
{
  ...
  name[0] = meta_data {std::make_pair(eps*4, eps*12), std::make_pair(eps*5, eps*5), std::vector <int> {0}, 0, 8, 0,};
  name[1] = meta_data {std::make_pair(eps*5, eps*5), std::make_pair(eps*5, eps*4), std::vector <int> {0}, 8, 9, 0,};
  name[2] = meta_data {std::make_pair(eps*5, eps*4), std::make_pair(eps*5, eps*3), std::vector <int> {0}, 9, 10, 6,};

  name[3] = meta_data {std::make_pair(eps*4, eps*13), std::make_pair(eps*5, eps*7), std::vector <int> {1}, 0, 7, 0,};
  name[4] = meta_data {std::make_pair(eps*5, eps*7), std::make_pair(eps*5, eps*6), std::vector <int> {1}, 7, 8, 0,};
  name[5] = meta_data {std::make_pair(eps*5, eps*6), std::make_pair(eps*5, eps*2), std::vector <int> {1}, 8, 12, 4,};

  name[6] = meta_data {std::make_pair(eps*7, eps*13), std::make_pair(eps*5, eps*9), std::vector <int> {2}, 0, 6, 0,};
  name[7] = meta_data {std::make_pair(eps*5, eps*9), std::make_pair(eps*5, eps*8), std::vector <int> {2}, 6, 7, 0,};
  name[8] = meta_data {std::make_pair(eps*5, eps*8), std::make_pair(eps*5, eps*1), std::vector <int> {2}, 7, 14, 2,};

  name[9] = meta_data {std::make_pair(eps*7, eps*10), std::make_pair(eps*5, eps*11), std::vector <int> {3}, 0, 5, 0,};
  name[10] = meta_data {std::make_pair(eps*5, eps*11), std::make_pair(eps*5, eps*10), std::vector <int> {3}, 5, 6, 0,};
  name[11] = meta_data {std::make_pair(eps*5, eps*10), std::make_pair(eps*5, eps*0), std::vector <int> {3}, 6, 16, 0,};
