...
bool checkpathpossible(PrecedenceConstraintGraph &G){
	...
	// Space Information
	cv::Mat image = cv::imread("/home/rajat/melodic_ws/src/PCICTS/include/test_final.png", 0);
	std::string graph_file = std::string("/home/rajat/melodic_ws/src/PCICTS/data/graphs/graph0.graphml");
	...
	// Setup planner
	// PCICTS::CBS planner(image,numAgents,graph_files,start_config,goal_config,startTimesteps,goalTimesteps);
	return false;
}
